      ...
      <div className="relative w-11/12 rounded-xl border border-gray-200 bg-white shadow-sm md:w-1/2 lg:w-1/3 dark:border-neutral-800 dark:bg-[#13131a]">
        <div className="p-4 sm:p-7">
          ...
          <div className="mt-4 flex justify-end space-x-2">
            <button
              onClick={onAction}
              className="inline-flex w-full items-center justify-center gap-x-2 rounded-lg border border-transparent bg-green-600 px-4 py-2 text-sm font-semibold text-white hover:bg-green-700 disabled:pointer-events-none disabled:opacity-50"
            >
              {actionLabel}
            </button>
          </div>
